...
public class StringBuf : global::haxe.lang.HxObject {
	...
	public int get_length() {
		#line 36 "/usr/share/haxe/std/cs/_std/StringBuf.hx"
		return this.b.Length;
	}
	#line default
	
	public void @add<T>(T x) {
		#line 40 "/usr/share/haxe/std/cs/_std/StringBuf.hx"
		this.b.Append(((string) (global::Std.@string(x)) ));
	}
	#line default
	
	public void addSub(string s, int pos, global::haxe.lang.Null<int> len) {
		#line 44 "/usr/share/haxe/std/cs/_std/StringBuf.hx"
	...
	public virtual void addChar(int c) {
		unchecked {
			#line 49 "/usr/share/haxe/std/cs/_std/StringBuf.hx"
			if (( c >= 65536 )) {
				#line 50 "/usr/share/haxe/std/cs/_std/StringBuf.hx"
				this.b.Append(((char) (( (( c >> 10 )) + 55232 )) ));
				this.b.Append(((char) (( (( c & 1023 )) + 56320 )) ));
			}
			else {
				#line 53 "/usr/share/haxe/std/cs/_std/StringBuf.hx"
	...
	public string toString() {
		#line 58 "/usr/share/haxe/std/cs/_std/StringBuf.hx"
	...
	public override object __hx_setField(string field, int hash, object @value, bool handleProperties) {
		unchecked {
			#line 26 "/usr/share/haxe/std/cs/_std/StringBuf.hx"
			switch (hash) {
				case 98:
				{
					#line 26 "/usr/share/haxe/std/cs/_std/StringBuf.hx"
