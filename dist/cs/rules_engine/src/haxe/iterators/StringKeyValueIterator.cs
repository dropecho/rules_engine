...
namespace haxe.iterators {
	public class StringKeyValueIterator : global::haxe.lang.HxObject {
		...
		public StringKeyValueIterator(string s) {
			#line 38 "/usr/share/haxe/std/haxe/iterators/StringKeyValueIterator.hx"
		...
		protected static void __hx_ctor_haxe_iterators_StringKeyValueIterator(global::haxe.iterators.StringKeyValueIterator __hx_this, string s) {
			#line 32 "/usr/share/haxe/std/haxe/iterators/StringKeyValueIterator.hx"
			__hx_this.offset = 0;
			#line 39 "/usr/share/haxe/std/haxe/iterators/StringKeyValueIterator.hx"
			{
				#line 39 "/usr/share/haxe/std/haxe/iterators/StringKeyValueIterator.hx"
				__hx_this.s = s;
			}
		...
		public bool hasNext() {
			#line 46 "/usr/share/haxe/std/haxe/iterators/StringKeyValueIterator.hx"
		...
		public object next() {
			unchecked {
				#line 53 "/usr/share/haxe/std/haxe/iterators/StringKeyValueIterator.hx"
				int tmp = this.offset;
				#line 53 "/usr/share/haxe/std/haxe/iterators/StringKeyValueIterator.hx"
				string s = this.s;
				#line 53 "/usr/share/haxe/std/haxe/iterators/StringKeyValueIterator.hx"
		...
		public override double __hx_setField_f(string field, int hash, double @value, bool handleProperties) {
			unchecked {
				#line 31 "/usr/share/haxe/std/haxe/iterators/StringKeyValueIterator.hx"
				switch (hash) {
					case 1614780307:
					{
						#line 31 "/usr/share/haxe/std/haxe/iterators/StringKeyValueIterator.hx"
