...
namespace haxe {
	public class SysTools : global::haxe.lang.HxObject {
		...
		static SysTools() {
			unchecked{
				#line 9 "/usr/share/haxe/std/haxe/SysTools.hx"
		...
		public SysTools() {
			#line 5 "/usr/share/haxe/std/haxe/SysTools.hx"
		...
		public static string quoteUnixArg(string argument) {
			#line 22 "/usr/share/haxe/std/haxe/SysTools.hx"
			if (( argument == "" )) {
				#line 23 "/usr/share/haxe/std/haxe/SysTools.hx"
				return "\'\'";
			}
			
			#line 25 "/usr/share/haxe/std/haxe/SysTools.hx"
			if ( ! (new global::EReg("[^a-zA-Z0-9_@%+=:,./-]", "").match(argument)) ) {
				#line 26 "/usr/share/haxe/std/haxe/SysTools.hx"
				return argument;
			}
			
			#line 30 "/usr/share/haxe/std/haxe/SysTools.hx"
		...
		public static string quoteWinArg(string argument, bool escapeMetaCharacters) {
			unchecked {
				#line 48 "/usr/share/haxe/std/haxe/SysTools.hx"
				if ( ! (new global::EReg("^[^ \t\\\\\"]+$", "").match(argument)) ) {
					#line 52 "/usr/share/haxe/std/haxe/SysTools.hx"
					...
					#line 55 "/usr/share/haxe/std/haxe/SysTools.hx"
					if (needquote) {
						#line 56 "/usr/share/haxe/std/haxe/SysTools.hx"
						result.b.Append(((string) ("\"") ));
					}
					
					#line 58 "/usr/share/haxe/std/haxe/SysTools.hx"
					global::StringBuf bs_buf = new global::StringBuf();
					{
						#line 59 "/usr/share/haxe/std/haxe/SysTools.hx"
						int _g = 0;
						#line 59 "/usr/share/haxe/std/haxe/SysTools.hx"
						...
						while (( _g < _g1 )) {
							...
							int i = _g++;
							{
								#line 60 "/usr/share/haxe/std/haxe/SysTools.hx"
								global::haxe.lang.Null<int> _g2 = global::haxe.lang.StringExt.charCodeAt(argument, i);
								#line 60 "/usr/share/haxe/std/haxe/SysTools.hx"
								if ( ! (_g2.hasValue) ) {
									#line 71 "/usr/share/haxe/std/haxe/SysTools.hx"
									global::haxe.lang.Null<int> c = _g2;
									#line 71 "/usr/share/haxe/std/haxe/SysTools.hx"
									{
										#line 73 "/usr/share/haxe/std/haxe/SysTools.hx"
										if (( bs_buf.b.Length > 0 )) {
											#line 74 "/usr/share/haxe/std/haxe/SysTools.hx"
											{
												#line 74 "/usr/share/haxe/std/haxe/SysTools.hx"
											...
											#line 75 "/usr/share/haxe/std/haxe/SysTools.hx"
											bs_buf = new global::StringBuf();
										}
										
										#line 77 "/usr/share/haxe/std/haxe/SysTools.hx"
									...
									switch (((_g2)).@value) {
										case 34:
										{
											#line 66 "/usr/share/haxe/std/haxe/SysTools.hx"
											string bs = bs_buf.b.ToString();
											result.b.Append(((string) (global::Std.@string(bs)) ));
											#line 68 "/usr/share/haxe/std/haxe/SysTools.hx"
											result.b.Append(((string) (global::Std.@string(bs)) ));
											bs_buf = new global::StringBuf();
											#line 70 "/usr/share/haxe/std/haxe/SysTools.hx"
											result.b.Append(((string) ("\\\"") ));
											#line 64 "/usr/share/haxe/std/haxe/SysTools.hx"
											break;
										}
										...
										case 92:
										{
											#line 63 "/usr/share/haxe/std/haxe/SysTools.hx"
					...
					#line 82 "/usr/share/haxe/std/haxe/SysTools.hx"
					{
						#line 82 "/usr/share/haxe/std/haxe/SysTools.hx"
					...
					#line 84 "/usr/share/haxe/std/haxe/SysTools.hx"
					if (needquote) {
						#line 85 "/usr/share/haxe/std/haxe/SysTools.hx"
						{
							#line 85 "/usr/share/haxe/std/haxe/SysTools.hx"
						...
						#line 86 "/usr/share/haxe/std/haxe/SysTools.hx"
						result.b.Append(((string) ("\"") ));
					}
					
					#line 89 "/usr/share/haxe/std/haxe/SysTools.hx"
					argument = result.b.ToString();
				}
				
				#line 92 "/usr/share/haxe/std/haxe/SysTools.hx"
				if (escapeMetaCharacters) {
					#line 93 "/usr/share/haxe/std/haxe/SysTools.hx"
					global::StringBuf result1 = new global::StringBuf();
					{
						#line 94 "/usr/share/haxe/std/haxe/SysTools.hx"
						int _g3 = 0;
						#line 94 "/usr/share/haxe/std/haxe/SysTools.hx"
						...
						while (( _g3 < _g11 )) {
							...
							#line 96 "/usr/share/haxe/std/haxe/SysTools.hx"
							if (( global::haxe.SysTools.winMetaCharacters.indexOf((c2).@value, default(global::haxe.lang.Null<int>)) >= 0 )) {
								#line 97 "/usr/share/haxe/std/haxe/SysTools.hx"
								result1.addChar(94);
							}
							
							#line 99 "/usr/share/haxe/std/haxe/SysTools.hx"
							result1.addChar((c2).@value);
						}
						
					}
					
					#line 101 "/usr/share/haxe/std/haxe/SysTools.hx"
					return result1.b.ToString();
				}
				else {
					#line 103 "/usr/share/haxe/std/haxe/SysTools.hx"
					return argument;
				}
