...
namespace haxe.ds._Vector {
	public sealed class Vector_Impl_ {
		...
		public static T1[] _new<T1>(int length) {
			#line 64 "/usr/share/haxe/std/haxe/ds/Vector.hx"
		...
		public static global::Array<T1> toArray<T1>(T1[] this1) {
			#line 202 "/usr/share/haxe/std/haxe/ds/Vector.hx"
			global::Array<T1> a = new global::Array<T1>();
			int len = ( ((T1[]) (this1) ) as global::System.Array ).Length;
			#line 209 "/usr/share/haxe/std/haxe/ds/Vector.hx"
			{
				#line 209 "/usr/share/haxe/std/haxe/ds/Vector.hx"
				int _g = 0;
				#line 209 "/usr/share/haxe/std/haxe/ds/Vector.hx"
			...
			#line 211 "/usr/share/haxe/std/haxe/ds/Vector.hx"
			return a;
		}
		#line default
		
		public static T1[] toData<T1>(T1[] this1) {
			#line 221 "/usr/share/haxe/std/haxe/ds/Vector.hx"
			return ((T1[]) (this1) );
		}
		#line default
		
		public static T[] fromData<T>(T[] data) {
			#line 231 "/usr/share/haxe/std/haxe/ds/Vector.hx"
			return ((T[]) (data) );
		}
		#line default
		
		public static T[] fromArrayCopy<T>(global::Array<T> array) {
			#line 255 "/usr/share/haxe/std/haxe/ds/Vector.hx"
		...
		public static void sort<T, T1>(T[] this1, global::haxe.lang.Function f) {
			#line 353 "/usr/share/haxe/std/haxe/ds/Vector.hx"
